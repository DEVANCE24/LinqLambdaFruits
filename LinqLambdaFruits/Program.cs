...
namespace LinqLambdaFruits
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            GetDetails(fruitDescendingOrderedLinq);
            Console.WriteLine();
            GetDetails(fruitAscendingOrderedLinq);
            Console.WriteLine();
            GetDetails(redAndGreenFruitLinq);
            Console.WriteLine();
            GetDetails(cheapestFruitLinq); 
            Console.WriteLine();
            GetDetails(expensiveFruitLinq);
            Console.WriteLine();
            GetDetails(budgetFruitsLinq);
            Console.WriteLine();
